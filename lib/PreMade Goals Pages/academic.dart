...
class academic extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    /**
     * This section is the code that creates the goal cards
     */
    ...
    //This is the beginning of the page UI
        ...
        children: [
          Column(children: [
            ...
            Container(
              ...
              //This is the beginning of where the goal cards are in the UI
              child: Padding(
                ...
                child: GridView.builder(
                    ...
                    itemBuilder: (BuildContext context, index) {
                      //The following section defines what happens when each
                      //goal tab is tapped
