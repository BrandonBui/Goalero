...
class cooking extends StatelessWidget {
  ...
  List<String> diffImages = [
    'images/tileImages/bbq.svg',
    'images/tileImages/groceryShopping.svg',
    'images/tileImages/cookingWithFriends.svg',
    'images/tileImages/onlineShopping.svg',
    'images/tileImages/vitamins.svg',
  ];
  @override
  Widget build(BuildContext context) {
    /**
     * This section is the code that builds the goal tile cards
     */
    Widget goalCard(index) => Column(
        ...
        children: [
          Column(children: [
            ...
            Container(
              ...
              //This is the beginning of where the tiles are located on the
              //main page
              child: Padding(
                ...
                child: GridView.builder(
                    ...
                    itemBuilder: (BuildContext context, index) {
                      //Tiles with their gesture detector are built here
                      return GestureDetector(
                        child: goalCard(index),
                        onTap: (() {
                          //The following are the tile options and what happens
                          //when the tile is tapped on
                          if (index == 0) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
