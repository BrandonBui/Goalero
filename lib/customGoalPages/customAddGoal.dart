        ...
        child: Column(
          children: [
            Container(
              ...
              Column( //align everything except back arrow in column 
                ...
                Padding(
                  ...
                  child: Text("Let's create a goal personalized for you!",style: GoogleFonts.poppins(
                                      color: Colors.black,
                                      fontSize: 20,
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed:(){
                          Navigator.push(context,MaterialPageRoute(builder: (context)=> goalType()));
                        }, 
