...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    //The onpressed code is just something I was experimenting with
    return Scaffold(
          ...
          child: Row(
            ...
            children: [
              IconButton(
                ...
                icon: pageIndex == 0
                    ? Image.asset('images/homeIconSelected.png')
              ...
              IconButton(
                ...
                icon: pageIndex == 1
                    ? Image.asset('images/chatIconSelected.png')
              ...
              Transform.scale(
                  ...
                  child: IconButton(
                    ...
                    icon: pageIndex == 2
                        ? Image.asset(
                            'images/addIcon.png',
                            color: Color(0xFF53937E),
                          )
                        : Image.asset('images/addIcon.png'),
