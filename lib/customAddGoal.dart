            ...
            Container(
              ...
              Center(
                child: Padding(
                  ...
                  child: SafeArea(
                    child: Text("Custom Goal", style: GoogleFonts.poppins(
                                    color: Colors.black,
                                    fontSize: 40,
               ...
               child: Padding(
                 ...
                 child: Column(
                  ...
                  children: [
                    Text("What is your activity's name?",style: GoogleFonts.poppins(
                                    color: Colors.black,
                                    fontSize: 15,
                    ...
                    SizedBox(height: 40,),
                    Text("What are your goals regarding this activity?",style: GoogleFonts.poppins(
                                    color: Colors.black,
                                    fontSize: 15,
                                    fontWeight: FontWeight.w300)),
                    SizedBox(height: 20,),
                    ...
                    SizedBox(height: 40,),
                    Text("At what time do you want to end this activity? (mm/dd/yyyy)",style: GoogleFonts.poppins(
                                    color: Colors.black,
                                    fontSize: 15,
                                    fontWeight: FontWeight.w300)),
                    SizedBox(height: 20,),
                ...
                child: SafeArea(
                  child: Container(
                    ...
                    child: ElevatedButton(child: Text("Submit Goal", style: GoogleFonts.poppins(
                                        color: Colors.black,
                                        fontSize: 15,
                                        fontWeight: FontWeight.w300),), style: ButtonStyle(backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 145, 175, 241)), shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)))), onPressed: () {
